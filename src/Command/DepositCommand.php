...
#[AsCommand('app:account:deposit', 'Deposit cents into an account.')]
final class DepositCommand extends Command
{
    ...
    protected function execute(InputInterface $in, OutputInterface $out): int
    {
        ...
        $this->service->deposit($acc, new Money((int)$in->getArgument('cents')));
        $out->writeln('OK');
        return 0;
    }
}
